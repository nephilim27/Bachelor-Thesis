    ...
    alter table if exists FoodEntry 
       drop constraint if exists FKeojmmhf2kugktxmnmbvj8xice;
    ...
    alter table if exists WorkoutEntry 
       drop constraint if exists FK9pdqns0dgtfymxl6paunacctu;
    ...
    alter table if exists FoodEntry 
       drop constraint if exists FKro16lbaqfjil9cjktv9pf4xt4;

    alter table if exists SleepEntry 
       drop constraint if exists FK9wh9io7xrjmgskmosjfq2kl7a;

    alter table if exists WaterEntry 
       drop constraint if exists FKjxa9xn54ndeijk19yre7a26r0;

    alter table if exists WorkoutEntry 
       drop constraint if exists FKib629ngqjjmrj19ugj1ka3d7b;
